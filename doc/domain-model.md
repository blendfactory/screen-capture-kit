...
| **CaptureResolution** | enum (`automatic`, `best`, `nominal`) | Output resolution / quality (`SCCaptureResolutionType` on `SCStreamConfiguration` for screenshots and live streams, macOS 14+). |
